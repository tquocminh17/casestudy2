...
namespace Illuminate\Http {
    ...
    class Request {
         ...
         * 
         *
         * @see \App\Providers\RequestServiceProvider::registerModelOrFailMethods()
         * @return \App\Models\User 
         * @static 
         */
        public static function userOrFail()
        {
            return \Illuminate\Http\Request::userOrFail();
        }

        /**
         * 
         *
         * @see \App\Providers\RequestServiceProvider::registerPrimitiveMethods()
         * @param string $key
         * @param string|null $timezone
         * @return \Carbon\CarbonImmutable 
         * @static 
         */
        public static function immutableDate($key, $timezone = null)
        {
            return \Illuminate\Http\Request::immutableDate($key, $timezone);
        }
